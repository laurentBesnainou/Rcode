...
var BubbleMapComponent = Component.extend({
  ...
  updateUIStrings: function updateUIStrings() {
    ...
    this.yInfoEl.html(iconQuestion).select("svg").attr("width", "0px").attr("height", "0px");
  ...
  preload: function preload() {
    ...
    var shape_path = this.model.ui.map.topology.path || globals.ext_resources.host + globals.ext_resources.preloadPath + "world-50m.json";
